    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header pb-2">
                <a href="{{ route('booking.index') }}" class="btn btn-success">Tambah</a>
            </div>
            <div class="card-body">
                            ...
                            <td class="align-middle">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('booking.edit', ['transaction' => $item->id]) }}"><i
                                            class="fa fa-edit text-warning"></i> Edit</a>
                                </div>
                            </td>
                            <td><a href="{{ route('bookings.checkout',['transaction'=>$item->id]) }}"
                                    class="btn btn-primary btn-sm">Checkout</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
