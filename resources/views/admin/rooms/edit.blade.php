                ...
                <form action="{{ route('rooms.update',['room'=>$rooms->id]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_room_id" class="form-control select2bs4 select2-hide-accessible"
                            ...
                            <option value="{{ $item->id }}" {{ $rooms->category_rooms->id==$item->id ? 'selected':''
                                }}>{{ $item->tipe }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="maks" class="form-control" id="maks" value="{{ $rooms->maks }}">
                    </div>
                    <div class="form-group">
                        <label for="status">Status</label>
                        <select name="status" class="form-control select2bs4 select2-hide-accessible" id="status">
